...
const CDashboard = () => {
  ...
  const TakeTest = () => {
    const testCode = "Elite6789"; // This should be dynamically set based on the ongoing test
    localStorage.setItem("userName", user.name);
    localStorage.setItem("userEmail", user.email); // Assuming user has an email property

    navigate("/start-test2", { state: { testCode }});
  };
