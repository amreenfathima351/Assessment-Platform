...
const navigate=useNavigate()
    ...
    const startVideoStream = async () => {
      if (isVideoVisible) {
        try {
          ...
          if (videoRef.current) {
            videoRef.current.srcObject = mediaStream; // Set the stream as the video source
  ...
  const handleVideoToggle = () => {
    ...
    if (capturedImage) setCapturedImage(null); // Clear captured image when toggling video
  };
