 ...
 const capitalizeName = (name) =>
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      setUser(updatedResponse.data); // Update state with new data

      // Show confirmation dialog
      if (
        window.confirm("Profile updated successfully. Click OK to continue.")
      ) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col items-center bg-gray-50 space-y-4">
                <img
                  ...
                  alt="Profile"
                  className="w-24 h-24 rounded-full shadow-md mt-8 object-cover"
                />
